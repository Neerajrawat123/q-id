...
function Footer() {
  return (
    <div className="bg-black border-t-2 border-gray-500 pb-10 w-full font-primary-font ">
      <div className="max-w-[1040px] mx-auto py-[50px] ">
        <div className="flex flex-col  gap-2">
          <div className="flex w-full border-b-[1px] border-gray-500 pb-4">
            <div className="w-3/5 items-center mt-10">
              <h2 className="text-[4rem] font-bold italic">qid</h2>
            </div>
